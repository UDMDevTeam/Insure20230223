        ...
        private static void Fill(INImport inimport, IDataReader reader)
        {
            try
            {
                if (reader["ID"] != DBNull.Value)
                {
                    ...
                    inimport.EmailStatus = reader["EmailStatus"] != DBNull.Value ? (string)reader["EmailStatus"] : (string)null;
