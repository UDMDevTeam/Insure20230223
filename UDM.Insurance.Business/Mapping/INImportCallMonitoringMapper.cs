        ...
        private static void Fill(INImportCallMonitoring inimportcallmonitoring, IDataReader reader)
        {
            try
            {
                if (reader["ID"] != DBNull.Value)
                {
                    ...
                    inimportcallmonitoring.WasDebiCheckProcessExplainedCorrectly = reader["WasDebiCheckProcessExplainedCorrectly"] != DBNull.Value ? (bool)reader["WasDebiCheckProcessExplainedCorrectly"] : (bool?)null;
                    ...
                    inimportcallmonitoring.Objections = reader["Objections"] != DBNull.Value ? (bool)reader["Objections"] : (bool?)null;
