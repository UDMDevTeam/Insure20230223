...
namespace UDM.Insurance.Business.Mapping
{
    ...
    public partial class INGiftRedeemMapper
    {
        ...
        private static void Fill(INGiftRedeem ingiftredeem, IDataReader reader)
        {
            try
            {
                if (reader["ID"] != DBNull.Value)
                {
                    ...
                    ingiftredeem.FKUserID = reader["FKUserID"] != DBNull.Value ? (long)reader["FKUserID"] : (long?)null;
        ...
        public static INGiftRedeemCollection Search(long? fkinimportid, long? fklkpgiftredeemstatusid, long? fkgiftoptionid, DateTime? redeemeddate, DateTime? poddate, string podsignature, bool? iswebredeemed, long? fkuserid, string connectionName)
        {
            INGiftRedeemCollection collection = new INGiftRedeemCollection();
            try
            {
                IDataReader reader = Database.ExecuteReader(connectionName, INGiftRedeemQueries.Search(fkinimportid, fklkpgiftredeemstatusid, fkgiftoptionid, redeemeddate, poddate, podsignature, iswebredeemed, fkuserid), null);
                while (reader.Read())
                {
                    INGiftRedeem ingiftredeem = new INGiftRedeem((long)reader["ID"]);
                    ingiftredeem.ConnectionName = connectionName;
        ...
        public static DataSet SearchData(long? fkinimportid, long? fklkpgiftredeemstatusid, long? fkgiftoptionid, DateTime? redeemeddate, DateTime? poddate, string podsignature, bool? iswebredeemed, long? fkuserid, string connectionName)
        {
            try
            {
                return Database.ExecuteDataSet(connectionName, INGiftRedeemQueries.Search(fkinimportid, fklkpgiftredeemstatusid, fkgiftoptionid, redeemeddate, poddate, podsignature, iswebredeemed, fkuserid), null);
            }
            catch (Exception ex)
            {
                throw new MapperException("Failed to search for INGiftRedeem objects in the database", ex);
        ...
        /// <param name="connectionName">Database connection name to use for the search.</param>
        /// <returns>A datareader containing the results of the search.</returns>
        public static INGiftRedeem SearchOne(long? fkinimportid, long? fklkpgiftredeemstatusid, long? fkgiftoptionid, DateTime? redeemeddate, DateTime? poddate, string podsignature, bool? iswebredeemed, long? fkuserid, string connectionName)
        {
