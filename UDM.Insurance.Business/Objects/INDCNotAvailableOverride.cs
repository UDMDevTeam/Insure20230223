...
{
    public partial class INDCNotAvailableOverride : ObjectBase<long>
    {
        #region Members
        private long? _fkimportid = null;
        private string _agentsavailable = null;
        #endregion
        ...
        /// </summary>
        public INDCNotAvailableOverride()
        {
            SetDefaults();
        }
        ...
        /// Creates a new instance of the CallData class.
        /// </summary>
        public INDCNotAvailableOverride(long id)
        {
            ID = id;
        }
        #endregion
        ...
        public string AgentsAvailable
        {
            ...
            {
                Fill();
                return _agentsavailable;
            }
            set 
            {
                Fill();
                if (value != _agentsavailable)
                {
                    _agentsavailable = value;
                    _hasChanged = true;
                }
            }
        }
        ...
        public override void Fill()
        {
            ...
            {
                _isPopulated = true;
                INDCNotAvailableOverrideMapper.Fill(this);
            }
        }
        ...
        public override bool Save(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                ...
                if (_hasChanged == true)
                {
                    _isLoaded = INDCNotAvailableOverrideMapper.Save(this);
                    result &= _isLoaded;
                }
                _hasChanged = !result;
        ...
        public override bool Delete(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                return BeforeDelete(validationResult) && INDCNotAvailableOverrideMapper.Delete(this);
            }
            else
            {
                return false;
        ...
        public override string ToXML()
        {
            ...
            xml.Append("<INDCNotAvailableOverride>");
            xml.Append("<fkimportid>" + FKImportID.ToString() + "</fkimportid>");
            xml.Append("<agentsavailable>" + AgentsAvailable.ToString() + "</agentsavailable>");
            xml.Append("</INDCNotAvailableOverride>");
            return xml.ToString();
        }
        #endregion
        ...
        /// <param name="agentsavailable"></param>
        /// <returns>A Validation Result object with the result of the fill opertation.</returns>
        public ValidationResult Fill(long? fkimportid, string agentsavailable)
        {
        ...
        public bool DeleteHistory(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                return INDCNotAvailableOverrideMapper.DeleteHistory(this);
            }
            else
            {
                return false;
        ...
        public bool UnDelete(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                return INDCNotAvailableOverrideMapper.UnDelete(this);
            }
            else
            {
                return false;
    ...
    /// </summary>
    public partial class INDCNotAvailableOverrideCollection : ObjectCollection<INDCNotAvailableOverride>
    { 
    }
    #endregion
}
