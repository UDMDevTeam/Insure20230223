...
{
    public partial class INUpgradeIDUpdate : ObjectBase<long>
    {
        #region Members
        ...
        /// Creates a new instance of the CallData class.
        /// </summary>
        public INUpgradeIDUpdate(long id)
        {
            ID = id;
        }
        #endregion
        ...
        public override void Fill()
        {
            ...
            {
                _isPopulated = true;
                INUpgradeIDUpdateMapper.Fill(this);
            }
        }
        ...
        public override bool Save(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                ...
                if (_hasChanged == true)
                {
                    _isLoaded = INUpgradeIDUpdateMapper.Save(this);
                    result &= _isLoaded;
                }
                _hasChanged = !result;
        ...
        public override bool Delete(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                return BeforeDelete(validationResult) && INUpgradeIDUpdateMapper.Delete(this);
            }
            else
            {
                return false;
        ...
        public override string ToXML()
        {
            ...
            xml.Append("<INUpgradeIDUpdate>");
            xml.Append("<fkimportid>" + FKImportID.ToString() + "</fkimportid>");
            xml.Append("<idnumber>" + IDNumber.ToString() + "</idnumber>");
            xml.Append("</INUpgradeIDUpdate>");
            return xml.ToString();
        }
        #endregion
        ...
        public ValidationResult Fill(long? fkimportid, string idnumber)
        {
        ...
        public bool DeleteHistory(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                return INUpgradeIDUpdateMapper.DeleteHistory(this);
            }
            else
            {
                return false;
        ...
        public bool UnDelete(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                return INUpgradeIDUpdateMapper.UnDelete(this);
            }
            else
            {
                return false;
    ...
    /// </summary>
    public partial class INUpgradeIDUpdateCollection : ObjectCollection<INUpgradeIDUpdate>
    { 
    }
    #endregion
}
