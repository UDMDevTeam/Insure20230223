...
{
    public partial class RejectedDebiCheckTracking : ObjectBase<long>
    {
        #region Members
        private long? _fkimportid = null;
        private DateTime? _datetimesaved = null;
        #endregion
        ...
        /// </summary>
        public RejectedDebiCheckTracking()
        {
            SetDefaults();
        }
        ...
        /// Creates a new instance of the CallData class.
        /// </summary>
        public RejectedDebiCheckTracking(long id)
        {
            ID = id;
        }
        #endregion
        ...
        public override void Fill()
        {
            ...
            {
                _isPopulated = true;
                RejectedDebiCheckTrackingMapper.Fill(this);
            }
        }
        ...
        public override bool Save(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                ...
                if (_hasChanged == true)
                {
                    _isLoaded = RejectedDebiCheckTrackingMapper.Save(this);
                    result &= _isLoaded;
                }
                _hasChanged = !result;
        ...
        public override bool Delete(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                return BeforeDelete(validationResult) && RejectedDebiCheckTrackingMapper.Delete(this);
            }
            else
            {
                return false;
        ...
        public override string ToXML()
        {
            ...
            xml.Append("<rejecteddebichecktracking>");
            xml.Append("<fkimportid>" + FKImportID.ToString() + "</fkimportid>");
            xml.Append("<datetimesaved>" + DateTimeSaved.ToString() + "</datetimesaved>");
            xml.Append("</rejecteddebichecktracking>");
            return xml.ToString();
        }
        #endregion
        ...
        public ValidationResult Fill(long? fkimportid, DateTime? datetimesaved)
        {
        ...
        public bool DeleteHistory(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                return RejectedDebiCheckTrackingMapper.DeleteHistory(this);
            }
            else
            {
                return false;
        ...
        public bool UnDelete(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                return RejectedDebiCheckTrackingMapper.UnDelete(this);
            }
            else
            {
                return false;
    ...
    /// </summary>
    public partial class RejectedDebiCheckTrackingCollection : ObjectCollection<RejectedDebiCheckTracking>
    { 
    }
    #endregion
}
