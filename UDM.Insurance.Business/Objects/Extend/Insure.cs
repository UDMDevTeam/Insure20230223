...
namespace UDM.Insurance.Business
{
    public class Insure
    {
        ...
        public static DataSet INGetDebiCheckError(DateTime fromDate, DateTime toDate)
        {
            //SqlParameter[] parameters = new SqlParameter[3];
            //parameters[0] = new SqlParameter("@CampaignID", campaignID);
            //parameters[1] = new SqlParameter("@FromDate", _startDate.ToString("yyyy-MM-dd"));
            ...
            return Database.ExecuteDataSet(null, CommandType.StoredProcedure, "spReportDebiCheckError", paramArray, 600);
        }
        ...
        public static DataSet INITQueriesReport(DateTime fromDate, DateTime toDate)
        {
            object param1 = Database.GetParameter("@DateFrom", fromDate);
            object param2 = Database.GetParameter("@DateTo", toDate);
            ...
            return Database.ExecuteDataSet(null, CommandType.StoredProcedure, "spReportITQueries", paramArray, 600);
        }

        public static DataSet INCMQueriesReport(DateTime fromDate, DateTime toDate)
        {
            object param1 = Database.GetParameter("@DateFrom", fromDate);
            object param2 = Database.GetParameter("@DateTo", toDate);
        ...
        public static DataSet INGetReportCallTransfer(int? fkINCampaignIDs, DateTime fromDate, DateTime toDate, string isupgrade, string IsSummary)
        {
            ...
            object param5 = Database.GetParameter("@IsSummary", IsSummary);
