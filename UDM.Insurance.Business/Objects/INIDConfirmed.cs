...
{
    public partial class INIDConfirmed : ObjectBase<long>
    {
        #region Members
        private long? _fkimportid = null;
        private string _confirmed = null;
        #endregion
        ...
        public override bool Save(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                ...
                if (_hasChanged == true)
                {
                    _isLoaded = INIDConfirmedMapper.Save(this);
                    result &= _isLoaded;
                }
                _hasChanged = !result;
        ...
        public override bool Delete(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                return BeforeDelete(validationResult) && INIDConfirmedMapper.Delete(this);
            }
            else
            {
                return false;
        ...
        public override string ToXML()
        {
            ...
            xml.Append("<INIDConfirmed>");
            xml.Append("<fkimportid>" + FKImportID.ToString() + "</fkimportid>");
            xml.Append("<confirmed>" + Confirmed.ToString() + "</confirmed>");
            xml.Append("</INIDConfirmed>");
            return xml.ToString();
        }
        #endregion
        ...
        public ValidationResult Fill(long? fkimportid, string confirmed)
        {
        ...
        public bool DeleteHistory(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                return INIDConfirmedMapper.DeleteHistory(this);
            }
            else
            {
                return false;
        ...
        public bool UnDelete(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                return INIDConfirmedMapper.UnDelete(this);
            }
            else
            {
                return false;
    ...
    /// </summary>
    public partial class INIDConfirmedCollection : ObjectCollection<INIDConfirmed>
    { 
    }
    #endregion
}
