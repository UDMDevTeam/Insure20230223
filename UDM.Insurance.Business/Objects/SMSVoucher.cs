...
{
    public partial class SMSVoucher : ObjectBase<long>
    {
        #region Members
        ...
        public override bool Save(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                ...
                if (_hasChanged == true)
                {
                    _isLoaded = SMSVoucherMapper.Save(this);
                    result &= _isLoaded;
                }
                _hasChanged = !result;
        ...
        public override bool Delete(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                return BeforeDelete(validationResult) && SMSVoucherMapper.Delete(this);
            }
            else
            {
                return false;
        ...
        public bool DeleteHistory(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                return SMSVoucherMapper.DeleteHistory(this);
            }
            else
            {
                return false;
        ...
        public bool UnDelete(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                return SMSVoucherMapper.UnDelete(this);
            }
            else
            {
                return false;
    ...
    /// </summary>
    public partial class SMSVoucherCollection : ObjectCollection<SMSVoucher>
    {
    }
    #endregion
}
