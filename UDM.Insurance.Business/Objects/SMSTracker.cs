...
{
    public partial class SMSTracker : ObjectBase<long>
    {
        #region Members
        ...
        public override bool Save(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                ...
                if (_hasChanged == true)
                {
                    _isLoaded = SMSTrackerMapper.Save(this);
                    result &= _isLoaded;
                }
                _hasChanged = !result;
        ...
        public override bool Delete(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                return BeforeDelete(validationResult) && SMSTrackerMapper.Delete(this);
            }
            else
            {
                return false;
        ...
        /// <summary>
        /// Fills the SMSTracker object from a list of parameters.
        /// </summary>
        ...
        public bool DeleteHistory(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                return SMSTrackerMapper.DeleteHistory(this);
            }
            else
            {
                return false;
        ...
        public bool UnDelete(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                return SMSTrackerMapper.UnDelete(this);
            }
            else
            {
                return false;
    ...
    /// </summary>
    public partial class SMSTrackerCollection : ObjectCollection<SMSTracker>
    { 
    }
    #endregion
}
