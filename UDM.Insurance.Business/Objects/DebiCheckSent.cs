...
{
    public partial class DebiCheckSent : ObjectBase<long>
    {
        #region Members
        ...
        public override bool Save(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                ...
                if (_hasChanged == true)
                {
                    _isLoaded = DebiCheckSentMapper.Save(this);
                    result &= _isLoaded;
                }
                _hasChanged = !result;
        ...
        public override bool Delete(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                return BeforeDelete(validationResult) && DebiCheckSentMapper.Delete(this);
            }
            else
            {
                return false;
        ...
        public bool DeleteHistory(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                return DebiCheckSentMapper.DeleteHistory(this);
            }
            else
            {
                return false;
        ...
        public bool UnDelete(ValidationResult validationResult)
        {
            if (ValidationResult.Check(ref validationResult))
            {
                return DebiCheckSentMapper.UnDelete(this);
            }
            else
            {
                return false;
    ...
    /// </summary>
    public partial class DebiCheckSentCollection : ObjectCollection<DebiCheckSent>
    { 
    }
    #endregion
}
