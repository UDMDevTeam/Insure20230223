...
namespace UDM.Insurance.Business.Queries
{
    ...
    internal abstract partial class INImportOtherQueries
    {
        ...
        internal static string Delete(INImportOther inimportother, ref object[] parameters)
        {
            ...
            {
                query = "INSERT INTO [zHstINImportOther] ([ID], [FKINImportID], [FKINBatchID], [RefNo], [AccountType], [StartDate], [EndDate], [ReferralFrom], [AddressFrom], [TimesRemarketed], [LastDateRemarketed], [CollectedDate], [CommencementDate], [DurationInForce], [DurationSinceOOF], [NumColls], [OOFDate], [OOFType], [UpgradeCount], [Premium], [Bank], [Last4Digits], [StampDate], [StampUserID]) SELECT [ID], [FKINImportID], [FKINBatchID], [RefNo], [AccountType], [StartDate], [EndDate], [ReferralFrom], [AddressFrom], [TimesRemarketed], [LastDateRemarketed], [CollectedDate], [CommencementDate], [DurationInForce], [DurationSinceOOF], [NumColls], [OOFDate], [OOFType], [UpgradeCount], [Premium], [Bank], [Last4Digits], [StampDate], [StampUserID] FROM [INImportOther] WHERE [INImportOther].[ID] = @ID; ";
        ...
        internal static string UnDelete(INImportOther inimportother, ref object[] parameters)
        {
            ...
            if (inimportother != null)
            {
                query = "INSERT INTO [INImportOther] ([ID], [FKINImportID], [FKINBatchID], [RefNo], [AccountType], [StartDate], [EndDate], [ReferralFrom], [AddressFrom], [TimesRemarketed], [LastDateRemarketed], [CollectedDate], [CommencementDate], [DurationInForce], [DurationSinceOOF], [NumColls], [OOFDate], [OOFType], [UpgradeCount], [Premium], [Bank], [Last4Digits], [StampDate], [StampUserID]) SELECT [ID], [FKINImportID], [FKINBatchID], [RefNo], [AccountType], [StartDate], [EndDate], [ReferralFrom], [AddressFrom], [TimesRemarketed], [LastDateRemarketed], [CollectedDate], [CommencementDate], [DurationInForce], [DurationSinceOOF], [NumColls], [OOFDate], [OOFType], [UpgradeCount], [Premium], [Bank], [Last4Digits], [StampDate], [StampUserID] FROM [zHstINImportOther] WHERE [zHstINImportOther].[ID] = @ID AND [zHstINImportOther].[StampDate] = (SELECT MAX([StampDate]) FROM [zHstINImportOther] WHERE [zHstINImportOther].[ID] = @ID) AND (SELECT COUNT(ID) FROM [INImportOther] WHERE [ID] = @ID) = 0; ";
        ...
        internal static string Fill(INImportOther inimportother, ref object[] parameters)
        {
            ...
            if (inimportother != null)
            {
                query = "SELECT [ID], [FKINImportID], [FKINBatchID], [RefNo], [AccountType], [StartDate], [EndDate], [ReferralFrom], [AddressFrom], [TimesRemarketed], [LastDateRemarketed], [CollectedDate], [CommencementDate], [DurationInForce], [DurationSinceOOF], [NumColls], [OOFDate], [OOFType], [UpgradeCount], [Premium], [Bank], [Last4Digits], [StampDate], [StampUserID] FROM [INImportOther] WHERE [INImportOther].[ID] = @ID";
                parameters = new object[1];
                parameters[0] = Database.GetParameter("@ID", inimportother.ID);
            }
            return query;
        ...
        internal static string FillHistory(INImportOther inimportother, long stampUserID, DateTime stampDate, ref object[] parameters)
        {
            ...
            if (inimportother != null)
            {
                query = "SELECT [ID], [FKINImportID], [FKINBatchID], [RefNo], [AccountType], [StartDate], [EndDate], [ReferralFrom], [AddressFrom], [TimesRemarketed], [LastDateRemarketed], [CollectedDate], [CommencementDate], [DurationInForce], [DurationSinceOOF], [NumColls], [OOFDate], [OOFType], [UpgradeCount], [Premium], [Bank], [Last4Digits], [StampDate], [StampUserID] FROM [zHstINImportOther] WHERE [zHstINImportOther].[ID] = @ID AND [zHstINImportOther].[StampUserID] = @StampUserID AND [zHstINImportOther].[StampDate] = @StampDate";
        ...
        internal static string Save(INImportOther inimportother, ref object[] parameters)
        {
            ...
            if (inimportother != null)
            {
                ...
                {
                    query.Append("INSERT INTO [zHstINImportOther] ([ID], [FKINImportID], [FKINBatchID], [RefNo], [AccountType], [StartDate], [EndDate], [ReferralFrom], [AddressFrom], [TimesRemarketed], [LastDateRemarketed], [CollectedDate], [CommencementDate], [DurationInForce], [DurationSinceOOF], [NumColls], [OOFDate], [OOFType], [UpgradeCount], [Premium], [Bank], [Last4Digits], [StampDate], [StampUserID]) SELECT [ID], [FKINImportID], [FKINBatchID], [RefNo], [AccountType], [StartDate], [EndDate], [ReferralFrom], [AddressFrom], [TimesRemarketed], [LastDateRemarketed], [CollectedDate], [CommencementDate], [DurationInForce], [DurationSinceOOF], [NumColls], [OOFDate], [OOFType], [UpgradeCount], [Premium], [Bank], [Last4Digits], [StampDate], [StampUserID] FROM [INImportOther] WHERE [INImportOther].[ID] = @ID; ");
                    ...
                    query.Append(" WHERE [INImportOther].[ID] = @ID"); 
                    parameters[21] = Database.GetParameter("@ID", inimportother.ID);
                }
                else
                {
                    query.Append("INSERT INTO [INImportOther] ([FKINImportID], [FKINBatchID], [RefNo], [AccountType], [StartDate], [EndDate], [ReferralFrom], [AddressFrom], [TimesRemarketed], [LastDateRemarketed], [CollectedDate], [CommencementDate], [DurationInForce], [DurationSinceOOF], [NumColls], [OOFDate], [OOFType], [UpgradeCount], [Premium], [Bank], [Last4Digits], [StampDate], [StampUserID]) VALUES(@FKINImportID, @FKINBatchID, @RefNo, @AccountType, @StartDate, @EndDate, @ReferralFrom, @AddressFrom, @TimesRemarketed, @LastDateRemarketed, @CollectedDate, @CommencementDate, @DurationInForce, @DurationSinceOOF, @NumColls, @OOFDate, @OOFType, @UpgradeCount, @Premium, @Bank, @Last4Digits, " + Database.CurrentDateTime + ", " + GlobalSettings.ApplicationUser.ID + ");");
