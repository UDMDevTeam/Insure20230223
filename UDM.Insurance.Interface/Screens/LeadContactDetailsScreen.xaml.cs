...
{
    public partial class LeadContactDetailsScreen
    {
        #region Constants
        ...
        public LeadContactDetailsScreen()
        {
            InitializeComponent();
        ...
        private void DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            { 
                ...
                DataTable dtContactNumbers = Methods.ExecuteStoredProcedure2("spINGetLeadContactNumbers", parameters, IsolationLevel.Snapshot, 300).Tables[0];
        ...
        private void RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                ...
                xdgContactDetails.DataSource = dtContactNumbers.AsEnumerable();
