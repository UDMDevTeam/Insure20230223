...
namespace UDM.Insurance.Interface.Screens
{
    ...
    public partial class ReportDateAnalysisScreen : BaseControl
    {

        public ReportDateAnalysisScreen()
        {
            InitializeComponent();
        }
        ...
        {
            ReportDateAnalysisScreenViewModel vm = (ReportDateAnalysisScreenViewModel)DataContext;
