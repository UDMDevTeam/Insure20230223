...
namespace UDM.Insurance.Interface.Screens
{
    ...
    public partial class MenuReportsScreen
    {
        ...
        private void btnR129Options_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ReportR129Options reportDebiCheckAccepted = new ReportR129Options();
                ShowDialog(reportDebiCheckAccepted, new INDialogWindow(reportDebiCheckAccepted));
        ...
        private void btnSMS_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ReportSMS reportDebiCheckAccepted = new ReportSMS();
                ShowDialog(reportDebiCheckAccepted, new INDialogWindow(reportDebiCheckAccepted));
        ...
        private void btnDCAnalysis_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ReportDCAnalysis reportDebiCheckAccepted = new ReportDCAnalysis();
                ShowDialog(reportDebiCheckAccepted, new INDialogWindow(reportDebiCheckAccepted));
        ...
        private void btnErrorMandateReport_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ReportDebiCheckError reportDebiCheckError = new ReportDebiCheckError();
                ShowDialog(reportDebiCheckError, new INDialogWindow(reportDebiCheckError));
            }
            catch (Exception ex)
            {
                HandleException(ex);
