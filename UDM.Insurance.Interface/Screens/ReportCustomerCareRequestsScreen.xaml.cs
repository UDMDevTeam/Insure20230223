...
namespace UDM.Insurance.Interface.Screens
{
    ...
    public partial class ReportCustomerCareRequestsScreen : BaseControl
    {

        public ReportCustomerCareRequestsScreen()
        {
            InitializeComponent();
        }
        ...
        {
            ReportCustomerCareRequestsScreenViewModel vm = (ReportCustomerCareRequestsScreenViewModel)DataContext;
