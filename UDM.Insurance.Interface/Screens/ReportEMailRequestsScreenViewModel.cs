...
{
    class ReportEMailRequestsScreenViewModel : BindableBase
    {
        ...
        private string _title = "EMail Requests Report";
        public string Title
        {
            get { return _title; }
        ...
        public ReportEMailRequestsScreenViewModel()
        {
        ...
        private void Report(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                string filePathAndName = $"{GlobalSettings.UserFolder}EMail Requests [{Convert.ToDateTime(SelectedFromDate).ToString("yyyy-MM-dd")} to {Convert.ToDateTime(SelectedToDate).ToString("yyyy-MM-dd")}], {DateTime.Now.ToString("ffff")}.xlsx";

                Uri uri = new Uri("/Templates/ReportTemplateEMailRequests.xlsx", UriKind.Relative);
                ...
                Worksheet wsTemplate = wbTemplate.Worksheets["eMail Requests"];
                Worksheet wsReport;
                ...
                DataSet dsReportData = Methods.ExecuteStoredProcedure2("spINReportEMailRequests", parameters, IsolationLevel.ReadUncommitted, 300);
                ...
                else
                {
                    ...
                    {
                        wsReport = wbReport.Worksheets.Add("eMail Requests");
