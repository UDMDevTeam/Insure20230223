...
{
    public partial class INSalesToCallMonitoringWindow
    {

        #region Constructor
        public INSalesToCallMonitoringWindow()
        {
            InitializeComponent();
        }

        public INSalesToCallMonitoringWindow(BaseControl baseControl): base(baseControl)
        {
            InitializeComponent();
        }

        public INSalesToCallMonitoringWindow(BaseControl baseControl, string message, string headerText, ShowMessageType messageType): base(baseControl, message, headerText, messageType)
        {
            InitializeComponent();
        }
        #endregion
