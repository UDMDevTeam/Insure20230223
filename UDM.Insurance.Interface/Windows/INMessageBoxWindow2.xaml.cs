...
{
    /// <summary>
    /// Interaction logic for HRMessageBoxWindow2.xaml
    /// </summary>
    public partial class INMessageBoxWindow2
    {
        #region Constructor
        public INMessageBoxWindow2()
        {
            InitializeComponent();
        }

        public INMessageBoxWindow2(BaseControl baseControl): base(baseControl)
        {
            InitializeComponent();
        }

        public INMessageBoxWindow2(BaseControl baseControl, string message, string headerText, ShowMessageType messageType): base(baseControl, message, headerText, messageType)
        {
            InitializeComponent();
        }
