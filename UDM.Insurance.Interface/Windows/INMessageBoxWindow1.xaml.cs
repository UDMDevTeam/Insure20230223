...
{
    public partial class INMessageBoxWindow1
    {

        #region Constructor
        public INMessageBoxWindow1()
        {
            InitializeComponent();
        }

        public INMessageBoxWindow1(BaseControl baseControl): base(baseControl)
        {
            InitializeComponent();
        }

        public INMessageBoxWindow1(BaseControl baseControl, string message, string headerText, ShowMessageType messageType): base(baseControl, message, headerText, messageType)
        {
            InitializeComponent();
        }
        #endregion
