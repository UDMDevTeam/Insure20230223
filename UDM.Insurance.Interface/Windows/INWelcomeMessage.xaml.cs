...
{
    public partial class INWelcomeMessage
    {

        #region Constructor
        public INWelcomeMessage()
        {
            InitializeComponent();
        }

        public INWelcomeMessage(BaseControl baseControl): base(baseControl)
        {
            InitializeComponent();
        }

        public INWelcomeMessage(BaseControl baseControl, string message, string headerText, ShowMessageType messageType): base(baseControl, message, headerText, messageType)
        {
            InitializeComponent();
        }
        #endregion
